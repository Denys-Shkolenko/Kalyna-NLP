...
public class TelegramService {
    ...
    public void sendVoice(Long chatId, InputFile inputFile, ReplyKeyboard replyKeyboard) {
    ...
    private void execute(SendVoice botApiMethod) {
        try {
    ...
    private void execute(SendMessage botApiMethod) {
        try {
            botSender.execute(botApiMethod);
        } catch (Exception e) {
            log.error("Exception: ", e);
